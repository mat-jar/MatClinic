class Appointment < ApplicationRecord
  belongs_to :patient
  belongs_to :doctor
  enum :time_slot, ["8:00", "8:20","8:40","9:00","9:20","9:40", "10:00","10:20","10:40",
  ...
  validates :date, comparison: { greater_than_or_equal_to: Date.today }, allow_blank: true
  validates :price, comparison: { greater_than: 0 }, allow_blank: true
